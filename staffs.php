...
<head>
  ...
  <title>My Antiques : Staffs</title>
  <!-- Bootstrap -->
  ...
  <div class="row">
    ...
    <form action="staffs.php" method="post" class="form-horizontal">
      ...
      <div class="form-group">
          ...
          <div class="col-sm-9">
          <input name="sfname" type="text" class="form-control" id="fname" placeholder="First Name" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_fname']; ?>" required>
        </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
          <input name="slname" type="text" class="form-control" id="slastname" placeholder="Last Name" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_lname']; ?>" required>
        </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="radio">
            <label>
              <input name="sgender" type="radio" id="staffgender" value="Male" <?php if(isset($_GET['edit'])) if($editrow['fld_staff_gender']=="Male") echo "checked"; ?>> Male
            </label>
          </div>
          <div class="radio">
            <label>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
          <input name="sphone" type="text" class="form-control" id="staffphone" placeholder="Number" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_phone']; ?>" required>
        </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
          <input name="smail" type="text" class="form-control" id="staffemail" placeholder="Email" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_email']; ?>" required>
        </div>
        </div>
         ...
         <div class="form-group">
          ...
          <div class="radio">
            <label>
              <input name="pos" type="radio" id="position" value="Supervisor" <?php if(isset($_GET['edit'])) if($editrow['fld_staff_position']=="Supervisor") echo "checked"; ?>> Supervisor
            </label>
          </div>
          <div class="radio">
            <label>
              <input name="pos" type="radio" id="position" value="Employee" <?php if(isset($_GET['edit'])) if($editrow['fld_staff_position']=="Employee") echo "checked"; ?>required> Employee
            </label>
            </div>
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      <nav>
          ...
          try {
            $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            $stmt = $conn->prepare("SELECT * FROM tbl_staffs_a172458_pt2");
            $stmt->execute(); 
            $result = $stmt->fetchAll();
