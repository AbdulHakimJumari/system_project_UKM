    ...
    <form action="products.php" method="post" class="form-horizontal">
      ...
      <div class="form-group">
         ...
         <select name="material" class="form-control" id="productmaterial" required>
            ...
            <option value="Brass" <?php if(isset($_GET['edit'])) if($editrow['fld_product_material']=="Brass") echo "selected"; ?>>Brass</option>
            <option value="Steel" <?php if(isset($_GET['edit'])) if($editrow['fld_product_material']=="North Face") echo "selected"; ?>>Steel</option>
            <option value="Wood" <?php if(isset($_GET['edit'])) if($editrow['fld_product_material']=="Wood") echo "selected"; ?>>Wood</option>
          </select>
        </div>
        </div>     
        <div class="form-group">
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
     ...
     $per_page = 5;
      ...
      <tr>
        ...
        <td>  
          <!--<a data-toggle="modal" href="products_details.php?pid=<?php echo $readrow['fld_product_num']; ?>" class="btn btn-warning btn-xs" role="button">Details</a> -->
