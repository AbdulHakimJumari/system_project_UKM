...
try {
  ...
  $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $stmt = $conn->prepare("SELECT * FROM tbl_orders_a172458_pt2, tbl_staffs_a172458_pt2,
      tbl_customers_a172458_pt2, tbl_orders_details_a172458_pt2 WHERE
      ...
      tbl_orders_a172458_pt2.fld_order_num = tbl_orders_details_a172458_pt2.fld_order_num AND
      tbl_orders_a172458_pt2.fld_order_num = :oid");
  ...
  <div class="col-xs-5">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4>From: My Antiques Sdn. Bhd.</h4>
      </div>
      <div class="panel-body">
        <p>
        NO 32 JALAN KERAMAT 5 <br>
        KUALA LUMPUR <br>
        43241 <br>
        SELANGOR <br>
        </p>
