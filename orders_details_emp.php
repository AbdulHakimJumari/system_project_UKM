...
<?php include_once 'nav_bar_emp.php'; ?>
    ...
    try {
      ...
      $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $stmt = $conn->prepare("SELECT * FROM tbl_orders_a172458_pt2, tbl_staffs_a172458_pt2,
          tbl_customers_a172458_pt2 WHERE
          tbl_orders_a172458_pt2.fld_staff_num = tbl_staffs_a172458_pt2.fld_staff_num AND
          tbl_orders_a172458_pt2.fld_customer_num = tbl_customers_a172458_pt2.fld_customer_num AND
          fld_order_num = :oid");
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      ...
      <div class="form-group">
          ...
          ?>
          <option value="<?php echo $productrow['fld_product_num']; ?>"><?php echo $productrow['fld_product_num']." ".$productrow['fld_product_name']; ?></option>
          <?php
          }
          $conn = null;
          ?>
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      ...
      try {
        $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
          $stmt = $conn->prepare("SELECT * FROM tbl_orders_details_a172458_pt2,
            tbl_products_a172458_pt2 WHERE
            tbl_orders_details_a172458_pt2.fld_product_num = tbl_products_a172458_pt2.fld_product_num AND
          fld_order_num = :oid");
          $stmt->bindParam(':oid', $oid, PDO::PARAM_STR);
          $oid = $_GET['oid'];
        $stmt->execute();
      ...
      <tr>
        ...
        <td>
          <a href="orders_details_emp.php?delete=<?php echo $detailrow['fld_order_detail_num']; ?>&oid=<?php echo $_GET['oid']; ?>" onclick="return confirm('Are you sure to delete?');" class="btn btn-danger btn-xs" role="button">Delete</a>
        </td>
      </tr>
      <?php } ?>
      </table>
