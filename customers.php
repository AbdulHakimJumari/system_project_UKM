...
<head>
  ...
  <title>My Antuques : Customers</title>
  <!-- Bootstrap -->
...
<div class="container-fluid">
  <div class="row">
    ...
    <form action="customers_emp.php" method="post" class="form-horizontal">
      ...
      <div class="form-group">
          ...
          <div class="col-sm-9">
          <input name="fname" type="text" class="form-control" id="customername" placeholder="Customer First Name" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_fname']; ?>" required>
        </div>
        </div>
        <div class="form-group">
          <label for="customerlname" class="col-sm-3 control-label">Last Name</label>
          <div class="col-sm-9">
          <input name="lname" type="text" class="form-control" id="customername" placeholder="Customer Last Name" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_lname']; ?>" required>
        </div>
        </div>
        <div class="form-group">
        <label for="customergneder" class="col-sm-3 control-label">Gender</label>
          <div class="col-sm-9">
          <div class="radio">
            <label>
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      try {
        ...
        $stmt = $conn->prepare("select * from tbl_customers_a172458_pt2 LIMIT $start_from, $per_page");
        $stmt->execute();
      ...
      <tr>
        ...
        <td>
          <a href="customers_emp.php?edit=<?php echo $readrow['fld_customer_num']; ?>" class="btn btn-success btn-xs" role="button"> Edit </a>
          <a href="customers_emp.php?delete=<?php echo $readrow['fld_customer_num']; ?>" onclick="return confirm('Are you sure to delete?');" class="btn btn-danger btn-xs" role="button">Delete</a>
        </td>
      </tr>
      <?php } ?>
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      <nav>
          ...
          <?php } else { ?>
            <li><a href="customers_emp.php?page=<?php echo $page-1 ?>" aria-label="Previous"><span aria-hidden="true">«</span></a></li>
          <?php
          }
          for ($i=1; $i<=$total_pages; $i++)
            if ($i == $page)
              echo "<li class=\"active\"><a href=\"customers_emp.php?page=$i\">$i</a></li>";
            else
              echo "<li><a href=\"customers_emp.php?page=$i\">$i</a></li>";
          ?>
